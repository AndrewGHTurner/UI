...
public:
	...
	Derived& onClickLeftDown(function<void(EventData d)> lambda)
	{
	...
	Derived& onClickLeftDown(function<void(EventData d)> lambda, int& lambdaID)
	{
		UI* ui = UI::getInstance();
	...
	Derived& onClickLeftUp(function<void(EventData d)> lambda, bool allowSlideOff = false)
	{
		UI* ui = UI::getInstance();
	...
	Derived& onHoverEnter(function<void(EventData d)> lambda)
	{
		UI* ui = UI::getInstance();
	...
	Derived& onHoverExit(function<void(EventData d)> lambda)
	{
		UI* ui = UI::getInstance();
